  ...
  Future<List<Profile>?> getProfiles() async {
   ...
   Future<String> getAuthJab() async {
     ...
     final data= {
         ...
         final url = Uri.parse("$baseUrl/https://siska-ng.tech/Siska_api/ApproveregisterAddDB");
    final response =  await client.post(url,body: data);
    if (response.statusCode == 200) {
      await prefs.clear();
      client.close();
...
if(idProdi!=null){
  final data= {
    ...
    final url = Uri.parse("$baseUrl/Siska_api/get_user_all");
    final response =  await client.post(Uri.parse("$baseUrl/Siska_api/get_registrasi_by_prodi"),body: data);
   ...
   Future<List<Prodi>?> getProdi() async {
    ...
    final url = Uri.parse("$baseUrl/Siska_api/get_user_all");
    final response =  await client.post(Uri.parse("$baseUrl/Siska_api/get_prodi_all"),body: data);
    if (response.statusCode == 200) {
...
Future<List<News>?> getNews() async {
 var client = new http.Client();
    ...
    final url = Uri.parse("$baseUrl/Siska_api/get_user_all");
    final response =  await client.post(Uri.parse("$baseUrl/Siska_api/getNews"),body: data);
    print(response.body);
    if (response.statusCode == 200) {
      client.close();
      if(response.body=="0"){
 ...
 var client = new http.Client();
    ...
    final url = Uri.parse("$baseUrl/Siska_api/get_user_all");
    final response =  await client.post(Uri.parse("$baseUrl/Siska_api/get_timeline_penelitian"),body: data);
    print(response.body);
    if (response.statusCode == 200) {
      client.close();
      if(response.body=="0"){
 ...
 var client = new http.Client();
    ...
    final url = Uri.parse("$baseUrl/Siska_api/get_user_all");
    final response =  await client.post(Uri.parse("$baseUrl/Siska_api/get_timeline_penelitian_by_nim"),body: data);
    print(response.body);
    if (response.statusCode == 200) {
      client.close();
 ...
 var client = new http.Client();
    ...
    final url = Uri.parse("$baseUrl/Siska_api/get_user_all");
    final response =  await client.post(Uri.parse("$baseUrl/Siska_api/getJadwal"),body: data);
