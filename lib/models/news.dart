...
class News {
  ...
  factory News.fromJson(Map<String, dynamic> map) {
    return News(
        idBerita: map["idBerita"],
        judulBerita: map["judulBerita"],
        detailBerita: map["detailBerita"],
        fotoBerita: map["fotoBerita"],
        fileBerita: map["fileBerita"],
        tglBerita: map["tglBerita"],
        statusBerita: map["statusBerita"]);
  }
