...
List<TimelineModelData> timelineFromJson(String jsonData) {
  ...
  return [
    TimelineModelData(
        ...
        time: datas.tglPengajuanProposal != "Undecided"
            ? datas.tglPengajuanProposal
            : "",
        ...
        iconBackground: datas.tglPengajuanProposal != "Undecided"
            ? Colors.green
            : Colors.red),
    TimelineModelData(
        ...
        iconBackground: datas.verifikasiKelayakanKroposal != "Undecided"
            ? Colors.green
            : Colors.red),
    TimelineModelData(
        name: "Ujian Proposal",
        time: datas.tglVerifikasiUjianProposal != "Undecided"
            ? datas.tglVerifikasiUjianProposal
            : "",
        ...
        iconBackground: datas.tglVerifikasiUjianProposal != "Undecided"
            ? Colors.green
            : Colors.red),
    TimelineModelData(
        name: "Revisi Proposal",
        time: datas.tglVerifikasiRevisiProposal != "Undecided"
            ? datas.tglVerifikasiRevisiProposal
            : "",
        ...
        iconBackground: datas.tglVerifikasiRevisiProposal != "Undecided"
            ? Colors.green
            : Colors.red),
    TimelineModelData(
        name: "Upload Pratesis",
        time: datas.tglUploadPratesis != "Undecided"
            ? datas.tglUploadPratesis
            : "",
        ...
        iconBackground: datas.verifikasiPratesisKelayakan != "Undecided"
            ? Colors.green
            : Colors.red),
    TimelineModelData(
        name: "Ujian Pratesis",
        time: datas.tglStatusPratesisUjian != "Undecided"
            ? datas.tglStatusPratesisUjian
            : "",
        ...
        iconBackground: datas.tglStatusPratesisUjian != "Undecided"
            ? Colors.green
            : Colors.red),
    TimelineModelData(
        name: "Revisi Pratesis",
        time: datas.tglStatusPratesisPevisi != "Undecided"
            ? datas.tglStatusPratesisPevisi
            : "",
        ...
        iconBackground: datas.tglStatusPratesisPevisi != "Undecided"
            ? Colors.green
            : Colors.red),
    TimelineModelData(
        name: "Upload Tesis",
        ...
        iconBackground:
            datas.tglTesisUpload != "Undecided" ? Colors.green : Colors.red),
    TimelineModelData(
        name: "Ujian Tesis ",
        ...
        iconBackground:
            datas.tglTesisUjian != "Undecided" ? Colors.green : Colors.red),
    TimelineModelData(
        name: "Revisi Tesis ",
        time: datas.tglTesisUjian != "Undecided" ? datas.tglTesisUjian : "",
