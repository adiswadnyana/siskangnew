...
import 'package:SisKa/models/user.dart';
    ...
    final thirdCard = Padding(
      ...
      child: Material(
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              _buildIconTile(LineIcons.moneyCheck, Colors.red, 'My Wallet'),
              hr,
              _buildIconTile(LineIcons.star, Colors.blue, 'VIP Center'),
              hr,
              _buildIconTile(LineIcons.userPlus, Colors.orangeAccent, 'Find Friends'),
              hr,
              _buildIconTile(LineIcons.userTie, Colors.black, 'Blacklist'),
              hr,
