   ...
   void filterData(String key) async{
    ...
    if(key.length >=2){
      listData.forEach((item) {
        if(item.judulBerita!.toLowerCase().contains(key.toLowerCase()) || item.tglBerita!.toLowerCase().contains(key.toLowerCase()) ){
                  ...
                  text: TextSpan(
                      ...
                      text: news.judulBerita),
                                ...
                                child: new GestureDetector(
                                      onTap: () {
                                       setState(() { 
                                        Navigator.pushNamed(context, newsDetailsViewRoute,
