...
class _NotifSendScreenState extends State<NotifSendScreen> {
  ...
  void _callPostAPIng(BuildContext context) async {
    ...
    if (selectedValue == null) {
      showFlushbar("Perhatian", "Kriteria belum dipilih",
          LineIcons.exclamationCircle, Colors.orange, context);
    } else if (_judul.text == null) {
      showFlushbar("Perhatian", "Judul masih kosong",
          LineIcons.exclamationCircle, Colors.orange, context);
    } else if (_isi.text == null) {
      showFlushbar("Perhatian", "Pesan masih kosong",
          LineIcons.exclamationCircle, Colors.orange, context);
    } else {
      showDialog(
          context: context,
              ...
              actions: <Widget>[
                CupertinoDialogAction(
                    ...
                    onPressed: () {
                      ...
                      _saving = true;
                      apiService
                          .notifSend(_judul.text, _isi.text, selectedValue!)
                          .then((isSuccess) {
                        // setState(()  {
                        if (isSuccess) {
                          setState(() {
